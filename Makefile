...
DATA_SRCS := src/data/cfg.c src/data/users.c src/data/boards.c src/data/file_areas.c src/data/votes.c src/data/messages.c src/data/usrptr.c src/data/sstatus.c src/data/syscnt.c src/data/access.c src/data/usrday.c
